...
INSERT [dbo].[OasisSystem] ([OasisSystemID], [OasisSystemName], [OasisSystemDescription], [url], [Port], [SysConfigID]) 
		VALUES (@OasisSystemId, N'PiWind Oasis Mid Tier', N'PiWind Oasis Mid Tier', N'127.0.0.1', 8001, 4)                       ----to check
INSERT [dbo].[OasisSystem] ([OasisSystemID], [OasisSystemName], [OasisSystemDescription], [url], [Port], [SysConfigID])  ----to check
		VALUES (@OasisSystemId+1, N'PiWind API', N'PiWind Lookup Service', N'https://127.0.0.1:9000/oasis/api', NULL, NULL)
...
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@XSLTModelFileResourceID,N'MappingMapToPiWind_ModelLoc.xslt', N'Canonical to Model Loc Tranformation File', 1, 1, 105, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 110) --XSLT2
...
INSERT [dbo].[File] ([FileId], [FileName], [FileDesc], [SourceID], [OwnerID], [LocationID], [DateTimeCreated], [DateTimeUpdated], [DateTimeDeleted], [OwnerNameCreated], [OwnerNameUpdated], [OwnerNameDeleted], [FileTypeId]) VALUES (@ToAccAXSDFileID,		N'Generic_CanAcc_B.xsd', N'Canonical Acc Profile File', 1, 1, 106, getdate(), getdate(), NULL, N'Sys', N'Sys', NULL, 109) --XSD5b
...
insert into [ProfileElement] values (8+@ProfileElementId,'CITY',@LocProfileId,5,0)
insert into [ProfileElement] values (9+@ProfileElementId,'CITYCODE',@LocProfileId,5,0)
